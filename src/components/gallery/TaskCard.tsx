...
import { formatImageRatio } from '../../lib/gallery/size'
import { getParamDisplay, ActualValueBadge } from '../../lib/gallery/paramDisplay'
import { DEFAULT_IMAGES_MODEL } from '../../lib/api/apiProfiles'
import { isAgentTaskPromptPending } from '../../lib/gallery/taskPromptDisplay'
import { TaskActionButton } from './TaskActionButton'
import { CodeIcon, TransparentBgIcon } from '../common/icons'

interface Props {
  task: TaskRecord
  onReuse: () => void
  onEditOutputs: () => void
  onSetSeriesReference?: () => void
  onCompare?: () => void
  onDelete: () => void
            ...
            >
              ...
              {onCompare && (
                <TaskActionButton
                  tooltip="加入对比"
                  onClick={onCompare}
                  className="p-1.5 rounded-md hover:bg-cyan-50 dark:hover:bg-cyan-950/30 text-gray-400 hover:text-cyan-500 transition disabled:opacity-30"
