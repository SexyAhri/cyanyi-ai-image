...
import { ChevronLeftIcon, CollectionManageIcon, FavoriteIcon, TrashIcon } from '../common/icons'
...
export default function SearchBar({ showFavoriteControls = true }: { showFavoriteControls?: boolean }) {
  ...
  const showFavoriteNavButton = showFavoriteControls || Boolean(activeFavoriteCollectionId)
    ...
    <div ref={rootRef} data-no-drag-select className="mt-6 mb-4 flex gap-3">
      ...
      <div className="relative z-10 flex-1">
        ...
        <input
          ...
          type="text"
          placeholder={inCollectionOverview ? '搜索收藏夹名称...' : '搜索提示词、备注、标签、参数...'}
